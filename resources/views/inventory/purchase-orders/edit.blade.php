...
<div class="container-fluid">
    ...
    <div class="row mb-4 align-items-center">
        <div class="col">
            ...
            <small class="text-muted">{{ $purchaseOrder->po_number }}</small>
        </div>
        <div class="col-auto">
            <a href="{{ route('inventory.purchase-orders.show', $purchaseOrder) }}" class="btn btn-sm btn-outline-secondary">
        ...
        <div class="row g-3">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="date" name="expected_delivery_date"
                                   ...
                                   value="{{ old('expected_delivery_date', $purchaseOrder->expected_delivery_date) }}" required>
                        ...
                        <div class="mb-0">
                            ...
                            <textarea name="notes" class="form-control @error('notes') is-invalid @enderror"
                                      rows="3" placeholder="Optional notes...">{{ old('notes', $purchaseOrder->notes) }}</textarea>
            ...
            <div class="col-lg-8">
                ...
                <div class="d-flex gap-2 justify-content-end mt-3">
                    ...
                    <a href="{{ route('inventory.purchase-orders.show', $purchaseOrder) }}" class="btn btn-outline-secondary">
                        Cancel
                    </a>
                </div>
            </div>
...
// On validation failure restore old input; otherwise load existing items
@if(old('products'))
