            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('inventory.products.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            <label for="initial_quantity" class="col-md-4 col-form-label text-md-right">Initial Quantity</label>
                            <div class="col-md-6">
                                <input id="initial_quantity" type="number" class="form-control @error('initial_quantity') is-invalid @enderror" name="initial_quantity" value="{{ old('initial_quantity', 0) }}" min="0" required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="low_stock_threshold" type="number" class="form-control @error('low_stock_threshold') is-invalid @enderror" name="low_stock_threshold" value="{{ old('low_stock_threshold', 5) }}" min="1" required>
